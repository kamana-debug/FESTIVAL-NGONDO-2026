    ...
    <header class="site-header">
      <div class="container">
        <nav class="navbar" role="navigation" aria-label="${this.t('Navigation principale','Main navigation')}">
          <a href="index.html" class="nav-logo" aria-label="Accueil Festival Ngondo">
            <img src="../../images/logo-ngondo.png" alt="Logo du Festival Ngondo" onerror="this.style.display='none'">
          ...
          <ul class="nav-menu" id="nav-menu" role="list">
            ...
            <li class="nav-item" role="listitem">
              <a href="pirogue.html" class="nav-link">${this.t('Compétitions','Competitions')}</a>
              <ul class="dropdown">
                <li><a href="pirogue.html">${this.t('Course de pirogues','Pirogue Race')}</a></li>
          ...
          <button class="hamburger" id="hamburger" aria-label="${this.t('Ouvrir le menu','Open menu')}" aria-expanded="false" aria-controls="nav-menu">
      ...
      <div class="container">
        <div class="footer-top">
          <div class="footer-brand">
            ...
            <p>${this.t(
              'La plus grande fête rituelle et culturelle des peuples Sawa du Cameroun, inscrite au Patrimoine Culturel Immatériel de l\'UNESCO. Célébrée chaque année sur les berges du Wouri à Douala.',
              'The greatest ritual and cultural festival of the Sawa people of Cameroon, inscribed on the UNESCO Intangible Cultural Heritage list. Celebrated each year on the banks of the Wouri in Douala.'
            )}</p>
          ...
          <div class="footer-col">
            ...
            <ul>
              ...
              <li><a href="presse.html">${this.t('Salle de presse','Press')}</a></li>
